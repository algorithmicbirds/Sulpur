...
SulpurPipeline::SulpurPipeline(SulpurDevice& device, const std::string& vertexShaderFile,
...
PipelineConfigInfo SulpurPipeline::defaultPipelineConfigInfo(unsigned int width,
                                                             unsigned int height) {
